...
**Always produces** `.ai/thinks/{slug}.md` at the end.
...
- `.ai/project.md` — stack constraints
...
>
> Save this to `.ai/thinks/{slug}.md`?
...
Generate `.ai/thinks/{slug}.md` using `templates/think.tmpl.md`.
